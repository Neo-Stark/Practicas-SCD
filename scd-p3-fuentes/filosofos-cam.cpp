...
void funcion_filosofos(int id)
{
  ...
  while (true)
  {
    ...
    MPI_Send(NULL, 0, MPI_INT, id_camarero, etiq_sentarse, MPI_COMM_WORLD);
...
void funcion_camarero()
{
  ...
  while (true)
  {
    ...
    {
    case etiq_sentarse:
      MPI_Recv(NULL, 0, MPI_INT, filo, etiq_sentarse, MPI_COMM_WORLD, &estado);
      contador++;

      MPI_Send(NULL, 0, MPI_INT, filo, etiq_sentarse, MPI_COMM_WORLD);
      cout << " Hay " << contador << " filósofos sentados. " << endl;
      break;
